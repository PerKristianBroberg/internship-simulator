...
export default function PersonalityPage() {
    ...
    if (analyzing) {
        return (
            ...
            <div className="h-full bg-black dark:bg-white animate-pulse" style={{ width: "65%" }} />
            </div>
            <p className="text-zinc-500 dark:text-zinc-400">
            Evaluating emotional stability... measuring leadership potential... estimating snack frequency...
            </p>
            </div>
        );
    }
    ...
    if (submitted) {
        return (
            ...
            After advanced AI-driven behavioral modeling and 17 milliseconds of deep analysis,
            your personality profile has been categorized as:
            </p>
            ...
            Your results indicate excessive impulsivity, minimal teamwork tendencies,
            questionable time management, and a fascinating disregard for feedback.
            While your energy is admirable, your overall workplace compatibility is...
    ...
    return (
        ...
        Please respond honestly to the following statements on a scale of 1–5.  
